  ...
  allDeeds = [
    ...
    sp13 = new Deed('Vail', 140, 'green', 10, "", 0, 0, 70, 12,13),
...
var bank = new Bank();
    ...
    // console.log(allDeeds[20].owner);
    // console.log(bank.deeds[28].owner);
...
//property owned and player pays rent
  else {
    // if(deed.owner != player.name){
